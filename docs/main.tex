...
\begin{figure}
\includegraphics[width=1\linewidth]{main_files/figure-latex/pca-scatter-1} \caption{Exploration of Principal Components of Prediction Errors.}\label{fig:pca-scatter}
\end{figure}

\begin{figure}
\includegraphics[width=1\linewidth]{main_files/figure-latex/pca-density-1} \caption{Density of Principal Components of Prediction Errors.}\label{fig:pca-density}
\end{figure}
