...
The [Statistical Analysis] section will perform multivariate analysis of variance (MANOVA) [@johnson2018applied] on these datasets however, this section focus more on exploring the variation in the prediction error and number of components due to our design parameters and prediction methods through plots.
